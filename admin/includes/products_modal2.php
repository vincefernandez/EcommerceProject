        ...
        <form class="form-horizontal" method="POST" action="products_edit.php">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <select class="form-control" id="edit_size" name="size" required>
                <option selected id="selectedsize"></option>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              ...
              <input type="number" class="form-control" id="edit_quantity" name="quantity" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" required />
            </div>
